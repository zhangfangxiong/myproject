...
class Yaf_Request_Http extends Yaf_Request_Abstract
{
    ...
    public function getParams() {
        return array_merge($_REQUEST, $this->_params);
    }
    ...
    {
        $sOS = 'unknow';
        $sAgent = $this->getHttpUserAgent();
        if (preg_match('/iPhone/i', $sAgent)) {
            $sOS = 'iphone';
        } elseif (preg_match('/iPad/i', $sAgent)) {
            $sOS = 'ipad';
    ...
    {
        return $this->getOS() == 'iphone' || $this->getOS() == 'ipad';
    }
    ...
    public function getBrowser() 
    {
        $sBrowser = 'unknow';
        $sAgent = $this->getHttpUserAgent();
        if (preg_match('/Opera/i', $sAgent)) {
            $sBrowser = 'opera';
        } elseif (preg_match('/compatible/i', $sAgent) && preg_match('/MSIE/i', $sAgent) && !preg_match('/Opera/i', $sAgent)) {
            $sBrowser = 'ie';
        } elseif (preg_match('/Firefox/i', $sAgent)) {
            $sBrowser = 'firefox';
        } elseif (preg_match('/Safari/i', $sAgent) && !preg_match('/Chrome/i', $sAgent)) {
            $sBrowser = 'safari';
        } elseif (preg_match('/Chrome/i', $sAgent)) {
            $sBrowser = 'chrome';
        }
        return $sBrowser;
    }
    ...
    {
        $sAgent = $this->getHttpUserAgent();
        return preg_match('/QQ/i', $sAgent);
    }
    
    public function isWeixin()
    {
        $sAgent = $this->getHttpUserAgent();
        return preg_match('/MicroMessenger/i', $sAgent);
    }
}
